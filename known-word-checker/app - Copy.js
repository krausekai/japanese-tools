...
var kanjiGaRegex = new RegExp(/([\u4e00-\u9faf\u3400-\u4dbf])(が)(?!っ|り|ん|れ|ら|け|ち|せ|さ|る|す|む)/, "g"); // separate kanji from が but not before verb auxillaries
...
var onomatopoeiaRegex = new RegExp(/([\u3040-\u309f]{2})(\1)/, "g") // separate repeated 2-char sequences which are onomatopoeia like ただただ, がりがり, etc
var text = "";
