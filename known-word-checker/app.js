...
var segs = [];
var termsToReplace = /ことを|のを|を|とき|くらい|ぐらい|ほど|ほぼ|からも|まで|より|など|とか|ということです|ことです|ことで|ことだ|こと|もの|だろう|だろ|でしょう|でしょ|みましょう|しょう|みよう|による|によれば|よる|によります|よります|によって|よって|について|ついて|についた|に対して|に対し|における|ばかり|ありながら|ながら|ながら|為にも|為に|ためにも|ために|ための|為|ため|しよう|みよう|ように|ような|よう|みたいな|みたい|けれど|けど|ですが|なんですが|のですが|んです|のです|のでした|でした|です|だから|なので|ので|なんだった|なんだ|んだった|んだ|のだった|だった|のだ|っす|いる|いられない|いない|います|いません|ある|あって|あったら|あった|あります|ありました|ありません|おる|おります|しまう|しまって|しまった|しまえ|しまい|ヤっちゃう|ちゃう|ちゃって|ちゃった|ちゃい|ください|下さい|くださる|下さる|宜しくお願いします|よろしくおねがいします|宜しく|よろしく|お願い|願い|こそ|する|したい|したかった|こうした|そうした|しろよ|やる|やれた|やりたい|やりたかった|ヤリたい|ヤリたかった|やれる|やって|やったら|やった|ヤる|ヤレる|ヤれる|やります|やりました|はず|筈|わけ|訳|くれる|くれて|くれた|くれれば|くれます|くれました|くれません|くれませ|くれ|あげる|あげない|あげれる|あげた|あげて|あげます|あげまして|あげました|貰う|貰え|もらう|もらえる|もらえ|もらって|もらった|もらい|いただく|いただきたい|いただいた|いただいて|頂く|頂いた|頂きたい|頂い|頂き|いただき|のじゃない|んじゃない|のじゃん|んじゃん|じゃない|じゃありません|じゃあ|じゃ|たら|だら|として|にとって|において|おいた|なさい|いかない|いいか|良いか|いい|イイ|よい|良い|よくて|良くて|よかった|良かった|よければ|良ければ|よく|良く|よろしい|ありがとうざいました|ありがとう|ございます|ございました|たりする|たりしない|したり|たり|だり|だし|される|されて|された|され|させる|させて|ってのは|こういう|そういう|どういう|こういった|そういった|という|といった|といって|と言って|と言ったら|と言った|って言う|っていう|ってゆう|って言われた|って言われ|って言える|って思う|って思っていた|って思っている|って思って|って思った|と思う|と思っていた|と思っている|と思って|と思った|と思います|と思っていました|と思っています|と思いました|って思い|と思い|思う|思います|かける|かけた|かけていた|かけている|かけて|かかる|かかった|かかっていた|かかっている|かかって|なければいけない|なければならない|ならない|なきゃいけない|いけない|いけません|いける|このまま|そのまま|あそこの|そこの|ここの|ってこと|にした|にしました|にして|にしてた|にしていた|になる|となる|なる|なりたい|なりたくない|なれる|となります|になります|なります|なりません|なった|なって|なりました|なりまして|なりたくて|なれない|なくなり|ことが|ことは|のが|のは|できる|できて|できた|できます|できました|できません|できれば|できない|できなかった|できなければ|できなくて|できなく|できなさそう|ほうが|のうちに|のうち|うち|やめる|やめて|やめた|やめます|やめました|これから|これら|これは|これが|これ|コレ|それぞれ|それから|それら|それとも|それが|それは|それ|ソレ|あれら|あれ|この|その|こんな|そんな|あんな|どんな|どの|あの|ここに|ここ|ココ|そこに|そこ|あそこに|あそこ|こちら|こっち|そっち|あっち|どこ|こちら|そちら|どちらとも|どちら|どっち|どれ|どうして|どう|だれ|みんな|みなさん|皆さま|皆|誰|どなたか|どなた|彼ら|僕ら|俺ら|おれら|ひとたち|人たち|わたしたち|私たち|私達|彼たち|かれたち|僕たち|ぼくたち|俺たち|おれたち|君たち|きみたち|俺達|僕達|あなた|貴方|自分|私|僕|俺|貴方|貴方方|我々|私達|あの人|あのかた|我ら|わたしたち|お前たち|お前ら|お前|おまえ|それで|しかし|そして|そしたら|さらに|すでに|共に|ともに|とも|一緒に|一緒|いっしょに|やつ|ヤツ|ちょっと|そのうえ|なぜ|なんで|ほとんど|なお|まだ|未だ|やばい|ヤバイ|だって|及び|および|ちなみに|ちなみ|またすぐ|また|すぐに|すぐ|わかりやすく|わかる|とわかって|がわかって|わかった|分かる|分かった|わからない|わからなく|分からなく|分からない|わかります|わかりません|わかりました|分かります|分かりません|分かりました|こんにちは|こんにちわ|こんばんは|こんばんわ|全て|すべて|全部|ぜんぶ|凄い|すごい|すっごい|すごく|すっごく|凄く|スゴイ|やすい|にくい|づらい|つらい|なかなか|例えば|たとえ|ところ|はじめて|はじめる|始める|始めて|初める|初めて|ほしい|欲しい|欲しそう|かもしれない|かもしれません|過ぎる|すぎる|過ぎない|すぎない|やりすぎ|だけでなく|ひとり|一人|二人|ひとつ|一つ|他に|ほかに|少し|すこし|みてね|くる|きた|いく|だね|のさ|での|もう|いつ|どこ|なんて|ひらがな|かたかな|カタカナ|にせず|かと|かを|には|とは|との|へと|への|べき|べく|上で|うえで|前に|後に|“|、|。|…|「|」|×|{|}/;
//あまり|あんまり|もっと|いっぱい|たくさん|とても|かなり|
var termsToReplaceRegex = new RegExp(termsToReplace, "g");
var alphaNumericRegex = new RegExp(/[a-zA-Z]+/, "g");
...
var otherSuffixRegex = new RegExp(/(氏|さん|君|くん|ちゃん|坊|達|たちも|たち|だち|者団|者|院|率|々)/, "g");
var kanjiOtherSuffixRegex = new RegExp(/([\u4e00-\u9faf\u3400-\u4dbf])(神|用)/, "g");
var text = "";
async function processComparisonText() {
	...
	text = text.replace(alphaNumericRegex, "_");
	...
	for (var i = 0; i < segs.length; i++) {
		if (segs[i] && segs[i+1]) {
			...
			// RE-COMBINE suffixes
			let suffixes = ["様", "さま", "氏", "さん", "君", "くん", "ちゃん", "坊", "達", "たち", "たちも", "だち", "ら"];
...
var suruRegex1 = new RegExp(/する/, "g");
var suruRegex2 = new RegExp(/します|される|させる/, "g");
var suruRegex3 = new RegExp(/されます|させます/, "g");
function purify(term) {
	...
	// Remove ending する, or します or される or させる
	if (term.length > 2) { // Prevent undefined terms by checking length
		term = term.replace(suruRegex1, "");
	}
	else if (term.length > 3) {
		term = term.replace(suruRegex2, "");
	}
	else if (term.length > 4) {
		term = term.replace(suruRegex3, "");
	}
